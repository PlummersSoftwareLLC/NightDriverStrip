...
const StatsPanel = ({ open, addNotification }) => {
    ...
    const { heapSize, dmaSize, psRamSize,
        chipCores, chipModel, chipSpeed, codeSize, codeFree,
        progSize, flashSize } = useContext(StatsContext);
    ...
    const getStats = (aborter) => fetch(`${httpPrefix !== undefined ? httpPrefix : ""}/statistics/dynamic`, { signal: aborter.signal })
        .then(resp => resp.json())
        .then(stats => {
            ...
            return {
                ...
                Memory: {
                    ...
                    PSRAM: {
                        stat: {
                            USED: psRamSize - stats.PSRAM_FREE,
