...
export declare class Sankey extends PureComponent<Props, State> {
    ...
    renderTooltip(): React.ReactElement<import("../component/Tooltip").TooltipProps<import("../component/DefaultTooltipContent").ValueType, string | number>, string | ((props: any) => React.ReactElement<any, any>) | (new (props: any) => React.Component<any, any, any>)>;
    render(): JSX.Element;
}
export {};
