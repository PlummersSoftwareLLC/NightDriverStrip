...
const { Box, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Slide, Button, TextField, FormControlLabel, useTheme, LinearProgress, CircularProgress , Popover } = window.MaterialUI;
