...
//    from the serial port. When data is received, the callback function
//    parses the data using parse_improv_serial_byte from the improv
//    namespace and sends a response using build_rpc_response from the
//    improv namespace. The response consists of the command type and a
//    vector of strings.
//
// Description:
//
...
//
// History:     Oct-9-2018         Davepl      File based on (Apache 2.0
// License)
...
static const char *const STATUS_UUID =
    "00467768-6228-2272-4663-277478268001";
static const char *const ERROR_UUID =
