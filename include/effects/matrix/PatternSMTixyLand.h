...
class PatternSMTixyLand : public EffectWithId<PatternSMTixyLand>
{
  private:
  ...
  public:
    ...
    PatternSMTixyLand() : EffectWithId<PatternSMTixyLand>("TixyLand")
    {
    }

    // Runs only the specific effect #effect.
    PatternSMTixyLand(const String& name, int effect) : EffectWithId<PatternSMTixyLand>(name), _name(name), _effect(effect)
    {
    }


    PatternSMTixyLand(const JsonObjectConst &jsonObject) : EffectWithId<PatternSMTixyLand>(jsonObject), _effect(jsonObject["effect"])
    {
    }
