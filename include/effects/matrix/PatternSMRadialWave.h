...
// A three-veined swirl rotates and changes direction, looking like an
// exhaust.
...
public:
    PatternSMRadialWave() :
        EffectWithId<PatternSMRadialWave>("RadialWave")
    {
    }
    PatternSMRadialWave(const JsonObjectConst &jsonObject) :
        EffectWithId<PatternSMRadialWave>(jsonObject)
    {
    }
