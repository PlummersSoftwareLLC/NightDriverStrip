...
class PatternSMTwist : public EffectWithId<PatternSMTwist>
{
  private:
  ...
  public:
    PatternSMTwist() : EffectWithId<PatternSMTwist>("Twist")
    {
    }

    PatternSMTwist(const JsonObjectConst &jsonObject) : EffectWithId<PatternSMTwist>(jsonObject)
    {
    }
