...
#if ENABLE_AUDIO
class PatternSMGravityBalls : public BeatEffectBase, public LEDStripEffect
#else
class PatternSMGravityBalls : public LEDStripEffect
#endif

// Derived from https://editor.soulmatelights.com/gallery/1895-agressivebouncingballs
