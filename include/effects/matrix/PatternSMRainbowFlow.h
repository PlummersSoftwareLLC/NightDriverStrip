...
class PatternSMRainbowFlow : public LEDStripEffect
{
  ...
  public:
    PatternSMRainbowFlow() : LEDStripEffect(EFFECT_MATRIX_SMRAINBOW_FLOW, "Rainbow Flow")
    {
    }

    PatternSMRainbowFlow(const JsonObjectConst &jsonObject) : LEDStripEffect(jsonObject)
    {
    }
