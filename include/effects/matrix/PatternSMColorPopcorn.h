...
#define NUM_ROCKETS 8
  ...
  public:
    PatternSMColorPopcorn() : LEDStripEffect(EFFECT_MATRIX_SMCOLOR_POPCORN, "Color Popcorn")
    {
    }

    PatternSMColorPopcorn(const JsonObjectConst &jsonObject) : LEDStripEffect(jsonObject)
    {
    }
