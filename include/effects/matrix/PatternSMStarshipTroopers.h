...
#undef WU_WEIGHT
  ...
  public:
    PatternSMStarshipTroopers() : LEDStripEffect(EFFECT_MATRIX_SMSTARSHIP_TROOPERS, "Starship Troopers")
    {
    }

    PatternSMStarshipTroopers(const JsonObjectConst &jsonObject) : LEDStripEffect(jsonObject)
    {
    }
