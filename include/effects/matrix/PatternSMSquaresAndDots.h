...
class PatternSMSquaresAndDots : public LEDStripEffect
{
  ...
  public:
    PatternSMSquaresAndDots() : LEDStripEffect(EFFECT_MATRIX_SMSQUARES_AND_DOTS, "Squares and Dots")
    {
    }

    PatternSMSquaresAndDots(const JsonObjectConst &jsonObject) : LEDStripEffect(jsonObject)
    {
    }
