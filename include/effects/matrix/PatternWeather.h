...
//              Nov-15-2023         mggates         Updated to use better
//              weather icons
//
//---------------------------------------------------------------------------
...
extern const uint8_t brokenclouds_start[] asm(
    "_binary_assets_bmp_brokenclouds_jpg_start");
extern const uint8_t brokenclouds_end[] asm(
    "_binary_assets_bmp_brokenclouds_jpg_end");
extern const uint8_t brokenclouds_night_start[] asm(
    "_binary_assets_bmp_brokencloudsnight_jpg_start");
extern const uint8_t brokenclouds_night_end[] asm(
    "_binary_assets_bmp_brokencloudsnight_jpg_end");
extern const uint8_t clearsky_start[] asm(
    "_binary_assets_bmp_clearsky_jpg_start");
extern const uint8_t clearsky_end[] asm(
    "_binary_assets_bmp_clearsky_jpg_end");
extern const uint8_t clearsky_night_start[] asm(
    "_binary_assets_bmp_clearnight_jpg_start");
extern const uint8_t clearsky_night_end[] asm(
    "_binary_assets_bmp_clearnight_jpg_end");
extern const uint8_t fewclouds_start[] asm(
    "_binary_assets_bmp_fewclouds_jpg_start");
extern const uint8_t fewclouds_end[] asm(
    "_binary_assets_bmp_fewclouds_jpg_end");
extern const uint8_t fewclouds_night_start[] asm(
    "_binary_assets_bmp_fewcloudsnight_jpg_start");
extern const uint8_t fewclouds_night_end[] asm(
    "_binary_assets_bmp_fewcloudsnight_jpg_end");
extern const uint8_t mist_start[] asm(
    "_binary_assets_bmp_mist_jpg_start");
extern const uint8_t mist_end[] asm("_binary_assets_bmp_mist_jpg_end");
extern const uint8_t mist_night_start[] asm(
    "_binary_assets_bmp_mistnight_jpg_start");
extern const uint8_t mist_night_end[] asm(
    "_binary_assets_bmp_mistnight_jpg_end");
extern const uint8_t rain_start[] asm(
    "_binary_assets_bmp_rain_jpg_start");
extern const uint8_t rain_end[] asm("_binary_assets_bmp_rain_jpg_end");
extern const uint8_t rain_night_start[] asm(
    "_binary_assets_bmp_rainnight_jpg_start");
extern const uint8_t rain_night_end[] asm(
    "_binary_assets_bmp_rainnight_jpg_end");
extern const uint8_t scatteredclouds_start[] asm(
    "_binary_assets_bmp_scatteredclouds_jpg_start");
extern const uint8_t scatteredclouds_end[] asm(
    "_binary_assets_bmp_scatteredclouds_jpg_end");
extern const uint8_t scatteredclouds_night_start[] asm(
    "_binary_assets_bmp_scatteredcloudsnight_jpg_start");
extern const uint8_t scatteredclouds_night_end[] asm(
    "_binary_assets_bmp_scatteredcloudsnight_jpg_end");
extern const uint8_t showerrain_start[] asm(
    "_binary_assets_bmp_showerrain_jpg_start");
extern const uint8_t showerrain_end[] asm(
    "_binary_assets_bmp_showerrain_jpg_end");
extern const uint8_t showerrain_night_start[] asm(
    "_binary_assets_bmp_showerrainnight_jpg_start");
extern const uint8_t showerrain_night_end[] asm(
    "_binary_assets_bmp_showerrainnight_jpg_end");
extern const uint8_t snow_start[] asm(
    "_binary_assets_bmp_snow_jpg_start");
extern const uint8_t snow_end[] asm("_binary_assets_bmp_snow_jpg_end");
extern const uint8_t snow_night_start[] asm(
    "_binary_assets_bmp_snownight_jpg_start");
extern const uint8_t snow_night_end[] asm(
    "_binary_assets_bmp_snownight_jpg_end");
extern const uint8_t thunderstorm_start[] asm(
    "_binary_assets_bmp_thunderstorm_jpg_start");
extern const uint8_t thunderstorm_end[] asm(
    "_binary_assets_bmp_thunderstorm_jpg_end");
extern const uint8_t thunderstorm_night_start[] asm(
    "_binary_assets_bmp_thunderstormnight_jpg_start");
extern const uint8_t thunderstorm_night_end[] asm(
    "_binary_assets_bmp_thunderstormnight_jpg_end");

static constexpr auto pszDaysOfWeek =
    to_array({"SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"});

static std::map<const String, EmbeddedFile, std::less<const String>,
                psram_allocator<std::pair<const String, EmbeddedFile>>>
    weatherIcons = {
        ...
        {"03n", EmbeddedFile(scatteredclouds_night_start,
         scatteredclouds_night_end)                                              },
        {"04n",
         EmbeddedFile(brokenclouds_night_start, brokenclouds_night_end)          },
        {"09n",
         EmbeddedFile(showerrain_night_start,   showerrain_night_end)            },
        {"10n",            EmbeddedFile(rain_night_start,         rain_night_end)},
        {"11n",
         EmbeddedFile(thunderstorm_night_start, thunderstorm_night_end)          },
...
private:
     ...
     * The weather is obviously weather, and we don't want text overlaid
     * on top of our text
     *
    ...
    bool updateCoordinates()
    {
        ...
        const String &configLocation =
            g_ptrSystem->DeviceConfig().GetLocation();
        const String &configCountryCode =
            g_ptrSystem->DeviceConfig().GetCountryCode();
        const bool configLocationIsZip =
            g_ptrSystem->DeviceConfig().IsLocationZip();

        if (configLocationIsZip)
            url = "http://api.openweathermap.org/geo/1.0/zip"
                  "?zip=" +
                  urlEncode(configLocation) + "," +
                  urlEncode(configCountryCode) + "&appid=" +
                  urlEncode(
                      g_ptrSystem->DeviceConfig().GetOpenWeatherAPIKey());
        else
            url = "http://api.openweathermap.org/geo/1.0/direct"
                  "?q=" +
                  urlEncode(configLocation) + "," +
                  urlEncode(configCountryCode) + "&limit=1&appid=" +
                  urlEncode(
                      g_ptrSystem->DeviceConfig().GetOpenWeatherAPIKey());
        ...
        {
            debugE("Error fetching coordinates for location: %s",
        ...
        JsonObject coordinates = configLocationIsZip
                                     ? doc.as<JsonObject>()
                                     : doc[0].as<JsonObject>();
    ...
    bool getTomorrowTemps(float &highTemp, float &lowTemp)
    {
        ...
        String url =
            ...
            "?lat=" +
            strLatitude + "&lon=" + strLongitude + "&cnt=16&appid=" +
            urlEncode(g_ptrSystem->DeviceConfig().GetOpenWeatherAPIKey());
        http.begin(url);
        int httpResponseCode = http.GET();
        ...
        if (httpResponseCode > 0)
        {
            ...
            for (size_t i = 0; i < list.size(); ++i)
            {
                ...
                char entryStr[11];
                strftime(entryStr, sizeof(entryStr), "%Y-%m-%d",
                         entryLocal);

                // if it is tomorrow then figure out the min and max and
                // get the icon
                if (strcmp(dateStr, entryStr) == 0)
                {
                    ...
                    // Identify the maximum of the 3 hour maximum
                    // temperature
                    float entryMaximum = main["temp_max"];
                    dailyMaximum = std::max(dailyMaximum, entryMaximum);

                    // Identify the minimum of the 3 hour mimimum
                    // temperatures
                    float entryMinimum = main["temp_min"];
                    if (entryMinimum > 0)
                        dailyMinimum =
                            std::min(dailyMinimum, entryMinimum);

                    // Use the noon slot for the icon
                    if (slot == 4)
                        iconTomorrow =
                            entry["weather"][0]["icon"].as<String>();
                }
            }
            ...
            debugI("Got tomorrow's temps: Lo %d, Hi %d, Icon %s",
                   (int)lowTemp, (int)highTemp, iconTomorrow.c_str());
        ...
        {
            debugE("Error fetching forecast data for location: %s in "
                   "country: %s",
                   strLocation.c_str(), strCountryCode.c_str());
            http.end();
            return false;
        }
    }
    ...
    bool getWeatherData()
    {
        ...
        String url =
            ...
            "?lat=" +
            strLatitude + "&lon=" + strLongitude + "&appid=" +
            urlEncode(g_ptrSystem->DeviceConfig().GetOpenWeatherAPIKey());
        http.begin(url);
        int httpResponseCode = http.GET();
        if (httpResponseCode > 0)
        {
            ...
            debugI("Got today's temps: Now %d Lo %d, Hi %d, Icon %s",
                   (int)temperature, (int)loToday, (int)highToday,
                   iconToday.c_str());
        ...
        {
            debugE("Error fetching Weather data for location: %s in "
                   "country: %s",
                   strLocation.c_str(), strCountryCode.c_str());
            http.end();
            return false;
    ...
    bool HasLocationChanged()
    {
        bool locationChanged =
            g_ptrSystem->DeviceConfig().GetLocation() != strLocation;
        bool countryChanged =
            g_ptrSystem->DeviceConfig().GetCountryCode() !=
            strCountryCode;
...
public:
     ...
     */
    PatternWeather(const JsonObjectConst &jsonObject) :
        EffectWithId<PatternWeather>(jsonObject)
    {
    }
    ...
    bool Init(std::vector<std::shared_ptr<GFXBase>> &gfx) override
    {
        ...
        // Register a Network Reader task with no interval.  Will manually
        // flag in Draw()
    ...
    void Draw() override
    {
        ...
        g()->fillRect(0, 0, MATRIX_WIDTH, 9,
                      g()->to16bit(CRGB(0, 0, 128)));
        ...
        // If location and/or country have changed, trigger an update
        // regardless of timer, but not more than once every half a minute
        if (secondsSinceLastUpdate >= WEATHER_INTERVAL_SECONDS ||
            (HasLocationChanged() && secondsSinceLastUpdate >= 30s))
        {
            latestUpdate = now;
        ...
        if (iconEntry != weatherIcons.end())
        {
            ...
            if (JDR_OK != TJpgDec.drawJpg(0, 10, icon.contents,
                                          icon.length)) // Draw the image
        ...
        {
            auto icon = iconEntry->second;
            if (JDR_OK != TJpgDec.drawJpg(xHalf + 1, 10, icon.contents,
                                          icon.length)) // Draw the image
        ...
        if (g_ptrSystem->DeviceConfig().GetOpenWeatherAPIKey().isEmpty())
            ...
            g()->print((strLocationName.isEmpty() ? showLocation
                                                  : strLocationName)
                           .substring(0, (MATRIX_WIDTH - 2 * fontWidth) /
                                             fontWidth));
        ...
        g()->drawLine(xHalf, y, xHalf, MATRIX_HEIGHT - 1,
                      CRGB(0, 0, 128));
        y += 2 + fontHeight;
        ...
        const char *pszTomorrow =
            pszDaysOfWeek[(todayTime->tm_wday + 1) % 7];
