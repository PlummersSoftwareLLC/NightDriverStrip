...
// ***** SINUSOID3 / СИНУСОИД3 *****
  ...
  */
  ...
  void Draw() override
  {
      ...
      //float time_shift = float(millis()%(uint32_t)(30000*(1.0/((float)Speed/255))));
      ...
      //float center3x3x = float(e_s3_size * sin16(float(speedfactor * 134.3447 * time_shift))) / 0x7FFF - xemitterX;
