...
public:
    ...
    PatternSMSmoke(const JsonObjectConst &jsonObject) : EffectWithId<PatternSMSmoke>(jsonObject) {}
    ...
    void Draw() override
    {
        ...
        if (deltaHue & 0x01) //((deltaHue >> 2U) == 0U) // (orig) I'd like to connect some kind of multiplier to the
