...
// additional palettes
// converted from 4 colors to 16 for writing in PROGMEM at https://colordesigner.io/gradient-generator, but not sure if this is equivalent to CRGBPalette16()
// values of color constants here: https://github.com/FastLED/FastLED/wiki/Pixel-reference
...
const TProgmemRGBPalette16 *firePalettes[] = {
    &HeatColors_p, // // this palette is already in the main set. if both sets of palettes are connected in the effect, then a copy is not needed
    &WoodFireColors_p,
    &NormalFire_p,
    &NormalFire2_p,
    &LithiumFireColors_p,
...
// palette for the type of realistic waterfall (if the Scale slider is set to 100)
...
#if USE_AUDIO
class PatternSMLumenjerPalette : public BeatEffectBase, public LEDStripEffect
#else
...
private:
    ...
    // added changing the current palette (used in many effects below for the Scale slider)
