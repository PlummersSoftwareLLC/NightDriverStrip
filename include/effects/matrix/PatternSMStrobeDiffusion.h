...
// BUGBUG: This would look better if the snowflakes took longer to decay. I
// can't find the magic for blur2d().
...
//---------------------------------------
  ...
  if (Scale > 50)
  {
    ...
    // g()->blur2d(g()->leds, MATRIX_WIDTH, 0, MATRIX_HEIGHT, top_line_offset, 24);
    FPSdelay = LOW_DELAY;
    STEP = 1U;
    if (Scale < 75) {
      // chaos ---
