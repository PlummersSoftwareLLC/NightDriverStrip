...
class PatternSMWisp : public EffectWithId<PatternSMWisp>
{
  private:
...
#define NUM_LAYERSMAX 2
  ...
  public:
    PatternSMWisp() : EffectWithId<PatternSMWisp>("Wisp")
    {
    }

    PatternSMWisp(const JsonObjectConst &jsonObject) : EffectWithId<PatternSMWisp>(jsonObject)
    {
    }
