  ...
  void Draw() override {
    ...
    if (hue == 1) {
      ...
      if (getPixColorXY((center + 1U), centerY - 2) == atr_stop) {
        ...
        drawPixelXY((center + 1), centerY,
                    getPixColorXY((center + 1U), centerY - 2));
      }
      ...
      if (getPixColorXY((center + 2U), centerY + 1) == atr_light) {
        ...
        drawPixelXY((center), centerY + 1,
                    getPixColorXY((center + 2U), centerY + 1));
      }
