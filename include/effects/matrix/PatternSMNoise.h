...
DEFINE_GRADIENT_PALETTE(Analogous_1_gp){
    0, 3, 0, 255, 63, 23, 0, 255, 127, 67, 0, 255, 191, 142, 0, 45, 255, 255, 0, 0
};
...
DEFINE_GRADIENT_PALETTE(ib15_gp){
    0,   113, 91, 147, 72,  157, 88, 78, 89,  208, 85, 33,
...
DEFINE_GRADIENT_PALETTE(Fuschia_7_gp){
    0, 43, 3,   153, 63, 100, 4,   103, 127, 188,
...
DEFINE_GRADIENT_PALETTE(BlacK_Blue_gp){
    0, 0, 0, 0, 127, 0, 0, 45, 255, 0, 0, 255
};
...
DEFINE_GRADIENT_PALETTE(Deep_Sea_gp){
    0, 0, 1, 2, 148, 1, 7, 24, 194, 2, 31, 77, 226, 1, 108, 144, 255, 0, 237, 235
};
...
DEFINE_GRADIENT_PALETTE(shikon_22_gp){
    0,   2,   2,   2,   24,  217, 47,  0,  26,  2,   2,   2,   49,  126, 0,   1,   51,
