...
// Inspired by https://editor.soulmatelights.com/gallery/2252-overcomplicatedbubbles
// The flocking code gives the bubbles a bit of a swarming effect

#if ENABLE_AUDIO
class PatternSMBubbles : public BeatEffectBase, public LEDStripEffect
#else
...
public:
 ...
 for (int i = 5; i < count; i++) {
   ...
   drawPixelXYF(boid->location.x, boid->location.y, ColorFromPalette(OceanColors_p,boid->hue*15,xboid->bbrightness,LINEARBLEND));
