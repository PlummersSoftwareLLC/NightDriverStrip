...
//
// History:     Apr-05-2023         Rbergen      Created for
// NightDriverStrip
...
// Some common JSON properties to prevent typos. By project convention
// JSON properties at the LEDStripEffect level have a length of 2
// characters, and JSON properties of actual effects (i.e. LEDStripEffect
// subclasses) a length of 3. The purpose of this is keeping the effect
// list JSON as compact as possible. As the effect list JSON is not
// intended for "human consumption", legibility of the overall list is not
// much of a concern. As each effect instantiation has its own JSON
// object, clashes between JSON property names only have to be prevented
// within the scope of an individual effect (class).
