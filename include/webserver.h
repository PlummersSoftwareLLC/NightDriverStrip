...
class CWebServer
{
  ...
  public:
    ...
    void begin()
    {
        ...
        extern const uint8_t js_start[] asm("_binary_site_dist_assets_index_js_gz_start");
        extern const uint8_t js_end[] asm("_binary_site_dist_assets_index_js_gz_end");
        ...
        EmbeddedWebFile timezones_file(timezones_start, timezones_end - 1, "text/json", "gzip"); // end - 1 because of zero-termination
        ...
        ServeEmbeddedFile("/assets/index.js", js_file);
